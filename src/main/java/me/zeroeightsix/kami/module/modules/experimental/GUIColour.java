...
public class GUIColour extends Module {
    ...
    public Setting<Integer> modulered = this.register(Settings.integerBuilder("Tab List Red").withMinimum(0).withValue(13).withMaximum(255).build());
    public Setting<Integer> modulegreen = this.register(Settings.integerBuilder("Tab List Green").withMinimum(0).withValue(13).withMaximum(255).build());
    public Setting<Integer> moduleblue = this.register(Settings.integerBuilder("Tab List Blue").withMinimum(0).withValue(13).withMaximum(255).build());
}
