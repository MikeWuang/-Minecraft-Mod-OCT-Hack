...
// Rina.
@Module.Info(name = "EyeTrack", description = "A eye track or eye finder.", category = Module.Category.RENDER)
public class EyeTrack extends Module {
	...
	private void drawLine(EntityLivingBase event_) {
		...
		if (result.typeOfHit == RayTraceResult.Type.BLOCK) {
			...
			KamiTessellator.drawBox(KamiTessellator.getBufferBuilder(), x, y, z, 1.01f, 1.01f, 1.01f, r, g, b, 70, GeometryMasks.Quad.ALL);
