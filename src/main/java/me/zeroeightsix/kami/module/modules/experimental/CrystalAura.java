 ...
 */
@Module.Info(name = "CrystalAura", category = Module.Category.EXPERIMENTAL, description = "Places End Crystals to kill enemies")
public class CrystalAura extends Module {
    ...
    public int onEnable() { sendMessage("&aENABLED&r");
        return 0;
    }
