...
public class AutoEZ extends Module {
	...
	public enum Mode {
		GG("gg, $NAME"),
		ONTOP("OCT on top! ez $NAME"),
		EZD("Go Fucking Cry To Your Mommy, $NAME"),
		EZ_HYPIXEL("Fucking Ezz, $NAME"),
		NAENAE("You just got Fucked By Wurst Plus, $NAME"),
		IMPACT("You just Got Killed By Impact CA, How Do You Feel?, $NAME"),
		CUSTOM();
